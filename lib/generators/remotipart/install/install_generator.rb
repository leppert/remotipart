...
module Remotipart
  module Generators
    class InstallGenerator < ::Rails::Generators::Base
      ...
      desc "This generator installs Form.js #{Remotipart::FORMJS_VERSION} and Remotipart #{Remotipart::VERSION}"
      source_root File.expand_path('../../../../../vendor/assets/javascripts', __FILE__)

      def install_formjs
        say_status "copying", "Form.js #{Remotipart::FORMJS_VERSION}", :green
