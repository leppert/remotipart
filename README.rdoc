...
* {The Rails jQuery driver (jquery-ujs)}[https://github.com/rails/jquery-ujs]
  Which can be installed with the {the jquery-rails gem}[http://rubygems.org/gems/jquery-rails]
  <b>PLEASE NOTE - DUE TO RECENT REFACTORING IN THE MASTER BRANCH OF JQUERY-UJS, YOU MUST USE THE VERSION CURRENTLY DISTRIBUTED WITH THE GEM (0.2.6). OR YOU CAN DIRECTLY INSTALL {THIS VERSION OF THE JQUERY-UJS}[https://github.com/rails/jquery-ujs/tree/51272c68714748420d8c35984b3e2532ab14f748]. A FIX IS ON THE WAY.</b>
